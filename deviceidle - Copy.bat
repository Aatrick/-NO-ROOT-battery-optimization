...
adb shell device_config put device_idle light_idle_to 60000
adb shell device_config put device_idle light_idle_factor 2
adb shell device_config put device_idle light_max_idle_to 300000
...
adb shell device_config put device_idle quick_doze_delay_to 30000


adb shell device_config put device_idle idle_to 3600000
adb shell device_config put device_idle idle_factor 2
adb shell device_config put device_idle max_idle_to 28800000


adb shell device_config put device_idle min_time_to_alarm 150000


adb shell device_config put device_idle max_temp_app_allowlist_duration_ms 30000
adb shell device_config put device_idle wait_for_unlock true


adb shell device_config put device_idle mms_temp_app_allowlist_duration_ms 30000
